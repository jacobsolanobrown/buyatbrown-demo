...
public class CreateUserHandler implements Route {
  ...
  public Object handle(Request request, Response response) {
    ...
    try {
      ...
      // TOOD: Maybe add more validation for emails - such as the format includes an @ symbol and
      // brown address
      System.out.println(
          "Creating user with UID: " + uid + ", username: " + username + ", email: " + email);
      ...
      //                      Map<String, Object> userDetailsMap = (Map<String, Object>)
      // userDetails;
      //                      System.out.println("Checking user details: " + userDetailsMap);
      //                      // check if the username is the same as the one we are trying to
      // create
      //                      Object existingUsername = userDetailsMap.get("username");
      //                      return existingUsername != null &&
      // existingUsername.toString().equalsIgnoreCase(username);
      //                    });
      //              }
      //            }
      //            return false;
      ...
      //        responseMap.put("response_type", "failure");
      //        responseMap.put("error", "User with the username \"" + username + "\" already
      // exists.");
      //        return Utils.toMoshiJson(responseMap);
      //      }
